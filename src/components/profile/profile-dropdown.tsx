        ...
        <div>
          <Menu.Button className="focus:outline-none">
            <div className="relative w-8 h-8">
              ...
              />
              <span className="absolute inline-flex items-center justify-center w-4 h-4 p-0 font-bold leading-none text-center text-white bg-amber-500 rounded-full top-[-6px] right-[-6px] text-xs ring-2 ring-white">
              5
            </span>
            </div>
          </Menu.Button>
