...
const Search: React.FC = () => (
  <div className="flex flex-col flex-wrap items-center justify-center w-full mt-8 mb-4">
    <div className="mb-2 text-2xl">How can we help you?</div>
    <div className="flex flex-row items-center justify-center w-full">
      <div className="relative w-full max-w-lg mb-2">
        <input
          ...
          name="search"
          placeholder="Search..."
          className="w-full h-10 pl-10 pr-5 text-sm bg-slate-100 rounded-full appearance-none focus:outline-none"
        />
    ...
    <div className="text-sm text-gray-500 dark:text-white">
      ...
      Startup, Funding, KYC, Evig Alpha
    </div>
  </div>
);
